...
public class MySwaggerResourceProvider implements SwaggerResourcesProvider {
    ...
    public List<SwaggerResource> get() {
        ...
        routeHosts.forEach(instance -> {
            ...
            String tmp = "";
            switch (instance){
                case "public-server":tmp = "pub";break;
                case "drug-server":tmp = "drug";break;
                case "outpatient-server":tmp = "outpatient";break;
                case "doctor-server":tmp="doctor";break;
                default: break;
            }
            String url = "/" + tmp + SWAGGER2URL;
